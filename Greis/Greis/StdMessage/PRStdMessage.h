...
namespace Greis
{
    ...
    public:
        ...
        struct Codes
        {
            static const std::string Code_RC;
            static const std::string Code_R1;
            static const std::string Code_R2;
            static const std::string Code_R3;
            static const std::string Code_R5;
            static const std::string Code_Rl;
        };
