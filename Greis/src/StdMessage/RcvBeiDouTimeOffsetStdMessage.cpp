#include "RcvBeiDouTimeOffsetStdMessage.h"
#include <cassert>
...
namespace Greis
{
    RcvBeiDouTimeOffsetStdMessage::RcvBeiDouTimeOffsetStdMessage( const char* pc_message, int p_length ) 
    ...
    QByteArray RcvBeiDouTimeOffsetStdMessage::ToByteArray() const
    {
        QByteArray result;
        if (!_isCorrect)
        {
