...
namespace Greis
{
    ...
    RcvTimeStdMessage::RcvTimeStdMessage( const std::string& p_id, int p_size ) 
        : _id(p_id), _bodySize(p_size - HeadSize())
    {
        _isCorrect = true;
    }

    RcvTimeStdMessage::RcvTimeStdMessage()
    {
        _id = "~~";
        _bodySize = 5;
        _isCorrect = true;
    ...
    RcvTimeStdMessage::RcvTimeStdMessage(const std::string& p_id)
    {
        _id = p_id;
        _bodySize = 5;
        _isCorrect = true;
