...
namespace Greis
{
    ...
    RcvGPSTimeOffsetStdMessage::RcvGPSTimeOffsetStdMessage( const std::string& p_id, int p_size ) 
    ...
    const std::string RcvGPSTimeOffsetStdMessage::Codes::Code_GO = "GO";
    ...
    bool RcvGPSTimeOffsetStdMessage::Validate() const
    {
    ...
    void RcvGPSTimeOffsetStdMessage::RecalculateChecksum()
    {
        if (!_isCorrect)
        {
            return;
