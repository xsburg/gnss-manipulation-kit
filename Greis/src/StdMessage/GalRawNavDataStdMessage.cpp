...
namespace Greis
{
    GalRawNavDataStdMessage::GalRawNavDataStdMessage( const char* pc_message, int p_length ) 
    ...
    GalRawNavDataStdMessage::GalRawNavDataStdMessage( const std::string& p_id, int p_size ) 
    ...
    bool GalRawNavDataStdMessage::Validate() const
    {
    ...
    void GalRawNavDataStdMessage::RecalculateChecksum()
    {
        if (!_isCorrect)
        {
            return;
    ...
    QByteArray GalRawNavDataStdMessage::ToByteArray() const
    {
        QByteArray result;
        if (!_isCorrect)
        {
